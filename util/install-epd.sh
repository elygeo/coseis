...
# Mac OS X
url="http://download.enthought.com/epd-7.0/epd-7.0-1-macosx-x86_64.dmg"
url="http://download.enthought.com/epd-7.0/epd-7.0-1-macosx-i386.dmg"
tag=$( basename "$url" )
cd "${prefix}"
...
# Linux
url="http://download.enthought.com/epd-7.0/epd-7.0-1-rh5-x86_64.sh"
url="http://download.enthought.com/epd-7.0/epd-7.0-1-rh3-x86_64.sh"
tag=$( basename "$url" .sh )
cd "${prefix}"
[ -e "${tag}.sh" ] || curl -O "${url}"
bash "${tag}.sh"
