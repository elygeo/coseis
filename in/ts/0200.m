% TeraShake 200m
  ...
  np = [ 1 188 4 ] % DS 94/265
  np = [ 1 116 4 ] % DS 58/265, TG 232
  np = [ 1 108 4 ] % DS 54/265, TG 216
  np = [ 1  80 4 ] % DS 40/265, TG 160
  dx = 200.;
  dt = .012;
  trelax = .12;
  nt = 15000;
  ...
  ihypo = [ 1362  997 -26 ];
  ihypo = [ 2266  997 -26 ];
% mus = [ 1.06 'zone'  1317   0 -81        2311  0 -1       ]; % node reg
  mus = [ 1.08 'zone'  1317   0 -81        2311  0 -1       ];
