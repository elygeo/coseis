% TeraShake 400m
  ...
  nt = 3750; itio = 400; itcheck = 800;
  nt = 7500; itio = 400; itcheck = 800;
  np = [ 1 58 4 ];
  np = [ 1 76 4 ];
  np = [ 1 32 4 ];
  np = [ 1 40 4 ];
  ...
  dx = 400.; dt = .024; trelax = .24;
  nn    = [ 1501  752 201 ];
  ihypo = [  682  499 -14 ];
  ihypo = [ 1133  499 -14 ];
% mus = [ 1.07 'zone'   659   0 -41        1156   0 -1       ];
  mus = [ 1.09 'zone'   659   0 -41        1156   0 -1       ];
  out = { 'x'      1    659 499 -41    0   1156 499 -1     0 };
  out = { 'rho'    1    659   0 -41    0   1156   0 -1     0 };
  out = { 'vp'     1    659   0 -41    0   1156   0 -1     0 };
  out = { 'vs'     1    659   0 -41    0   1156   0 -1     0 };
  out = { 'gam'    1    659   0 -41    0   1156   0 -1     0 };
  out = { 'gamt'   1    659   0 -41    0   1156   0 -1     0 };
...
% out = { 'vm2'  100      1   1  -1    0     -1  -1 -1  7500 };
% out = { 'vm2'  100      1   1  -1   20     -1  -1 -1  7500 };
% out = { 'vm2'  100      1   1  -1   40     -1  -1 -1  7500 };
% out = { 'vm2'  100      1   1  -1   60     -1  -1 -1  7500 };
% out = { 'vm2'  100      1   1  -1   80     -1  -1 -1  7500 };
