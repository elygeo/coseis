% Terashake 2000m
  ...
  ihypo = [ 138 101 -4 ];
  ihypo = [ 227 101 -4 ];
  mus = [ 1.03 'zone' 133 0 -9        232 0 -1      ];
  out = { 'x'     1   133 0 -9    0   232 0 -1    0 };
  out = { 'rho'   1   133 0 -9    0   232 0 -1    0 };
  out = { 'vp'    1   133 0 -9    0   232 0 -1    0 };
  out = { 'vs'    1   133 0 -9    0   232 0 -1    0 };
  out = { 'tn'   10   133 0 -9    0   232 0 -1   -1 };
  out = { 'tsm'  10   133 0 -9    0   232 0 -1   -1 };
  out = { 'sl'   10   133 0 -9    0   232 0 -1   -1 };
  out = { 'svm'  10   133 0 -9    0   232 0 -1   -1 };
  out = { 'psv'  10   133 0 -9    0   232 0 -1   -1 };
  out = { 'trup'  1   133 0 -9   -1   232 0 -1   -1 };
