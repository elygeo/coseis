% TeraShake 1000m
  ...
  nt = 3000; itio = 100; itcheck = 0;
  nt = 1500; itio = 100; itcheck = 0;
  np = [ 1 1 2 ];
  np = [ 1 8 4 ];
...
% out = { 'vm2'   50      1   1  -1    0     -1  -1 -1  3000 };
% out = { 'vm2'   50      1   1  -1   10     -1  -1 -1  3000 };
% out = { 'vm2'   50      1   1  -1   20     -1  -1 -1  3000 };
% out = { 'vm2'   50      1   1  -1   30     -1  -1 -1  3000 };
% out = { 'vm2'   50      1   1  -1   40     -1  -1 -1  3000 };
