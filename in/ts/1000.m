...
% return
  ...
  out = { 'pv2' 1500      1   1  -1 1500     -1  -1 -1   -1 };
% out = { 'pv2'   50      1   1  -1    0     -1  -1 -1   -1 };
% out = { 'pv2'   50      1   1  -1   10     -1  -1 -1   -1 };
% out = { 'pv2'   50      1   1  -1   20     -1  -1 -1   -1 };
% out = { 'pv2'   50      1   1  -1   30     -1  -1 -1   -1 };
% out = { 'pv2'   50      1   1  -1   40     -1  -1 -1   -1 };
% out = { 'vm2'   50      1   1  -1    0     -1  -1 -1   -1 };
% out = { 'vm2'   50      1   1  -1   10     -1  -1 -1   -1 };
% out = { 'vm2'   50      1   1  -1   20     -1  -1 -1   -1 };
% out = { 'vm2'   50      1   1  -1   30     -1  -1 -1   -1 };
% out = { 'vm2'   50      1   1  -1   40     -1  -1 -1   -1 };
