% TeraShake 4000m
  ...
  nt = 750; itio = 100; itcheck = 0;
  nt = 375; itio = 100; itcheck = 0;
  np = [ 1 1 21 ];
  np = [ 1 1 2 ];
  debug = 0;
nt = 0
...
% out = { 'vm2'    5      1   1  -1    0     -1  -1 -1   750 };
% out = { 'vm2'    5      1   1  -1    1     -1  -1 -1   750 };
% out = { 'vm2'    5      1   1  -1    2     -1  -1 -1   750 };
% out = { 'vm2'    5      1   1  -1    3     -1  -1 -1   750 };
% out = { 'vm2'    5      1   1  -1    4     -1  -1 -1  750 };
  out = { 'gamt'   1     67  51  -5    0    116  51 -1     0 };
