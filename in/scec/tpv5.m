% TPV5
  ...
  ts1 = { 75.8e6 'cube'  -1501. -1501. -1.   1501. 1499. 1. };
  ts1 = { 75.8e6 'cube'  -1499. -1501. -1.   1499. 1501. 1. };
  ts1 = { 81.6e6 'cube'  -1499. -1501. -1.   1499. 1499. 1. };

  ts1 = { 72.0e6 'cube'  -9001. -1501. -1.  -5999. 1501. 1. };
  ts1 = { 74.0e6 'cube'  -9001. -1501. -1.  -5999. 1499. 1. };
  ts1 = { 74.0e6 'cube'  -8999. -1501. -1.  -6001. 1501. 1. };
  ts1 = { 78.0e6 'cube'  -8999. -1501. -1.  -6001. 1499. 1. };

  ts1 = { 68.0e6 'cube'   5999. -1501. -1.   9001. 1501. 1. };
  ts1 = { 66.0e6 'cube'   5999. -1501. -1.   9001. 1499. 1. };
  ts1 = { 66.0e6 'cube'   6001. -1501. -1.   8999. 1501. 1. };
  ts1 = { 62.0e6 'cube'   6001. -1501. -1.   8999. 1499. 1. };
