% Terashake
  ...
  out = { 'vm'  10   1 1 -1  10   -1 -1 -1 -1 };
  out = { 'pv' 500   1 1 -1 500   -1 -1 -1 -1 };
...
% 4000m
  ...
  out = { 'psv'  10   67 0 -5 10   116 0 -1 100 };
  out = { 'trup' 10   67 0 -5 10   116 0 -1 100 };
return
...
% 2000m
  ...
  out = { 'sl'    10  133 0 -9  10   232 0 -1 1000 };
  out = { 'svm'   10  133 0 -9  10   232 0 -1 1000 };
  out = { 'psv'  100  133 0 -9 100   232 0 -1 1000 };
  out = { 'trup' 100  133 0 -9 100   232 0 -1 1000 };
return
...
% 1000m
  ...
  out = { 'sl'    10  264 0 -17  10   463 0 -1 1500 };
  out = { 'svm'   10  264 0 -17  10   463 0 -1 1500 };
  out = { 'psv'  100  264 0 -17 100   463 0 -1 1500 };
  out = { 'trup' 100  264 0 -17 100   463 0 -1 1500 };
return
...
% 200m
  ...
  out = { 'sl'    10 1317 0 -81  10   2311 0 -1 7500 };
  out = { 'svm'   10 1317 0 -81  10   2311 0 -1 7500 };
  out = { 'psv'  100 1317 0 -81 100   2311 0 -1 7500 };
  out = { 'trup' 100 1317 0 -81 100   2311 0 -1 7500 };
return
...
% 500m
  ...
  out = { 'sl'    10 527 0 -33  10   925 0 -1 3000 };
  out = { 'svm'   10 527 0 -33  10   925 0 -1 3000 };
  out = { 'psv'  100 527 0 -33 100   925 0 -1 3000 };
  out = { 'trup' 100 527 0 -33 100   925 0 -1 3000 };
return
...
% 400m
  ...
  out = { 'sl'    10 659 0 -41  10   1156 0 -1 3500 };
  out = { 'svm'   10 659 0 -41  10   1156 0 -1 3500 };
  out = { 'psv'  100 659 0 -41 100   1156 0 -1 3500 };
  out = { 'trup' 100 659 0 -41 100   1156 0 -1 3500 };
return
