...
% 4000m
  ...
  out = { 'tn'    1   67 0 -5   0   116 0 -1 100 };
  out = { 'tsm'   1   67 0 -5   0   116 0 -1 100 };
  out = { 'sl'    1   67 0 -5   0   116 0 -1 100 };
  out = { 'svm'   1   67 0 -5   0   116 0 -1 100 };
  out = { 'psv'   1   67 0 -5   0   116 0 -1 100 };
  out = { 'trup'  1   67 0 -5 100   116 0 -1 100 };
return
...
% 2000m
  ...
  out = { 'tn'   10   133 0 -9    0   232 0 -1 1000 };
  out = { 'tsm'  10   133 0 -9    0   232 0 -1 1000 };
  out = { 'sl'   10   133 0 -9    0   232 0 -1 1000 };
  out = { 'svm'  10   133 0 -9    0   232 0 -1 1000 };
  out = { 'psv'  10   133 0 -9    0   232 0 -1 1000 };
  out = { 'trup'  1   133 0 -9 1000   232 0 -1 1000 };
return
