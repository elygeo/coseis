...
% 1000m - Babieca
  ...
  out = { 'svm' 100   264 0 -17   463 0 -1 };
  out = { 'sum'  -1   264 0 -17   463 0 -1 };
  out = { 'sl'   -1   264 0 -17   463 0 -1 };
  out = { 'ts'   -1   264 0 -17   463 0 -1 };
...
% 4000m - Single processor
  ...
  out = { 'svm' 100   67 0 -5   116 0 -1 };
  out = { 'sum'  -1   67 0 -5   116 0 -1 };
  out = { 'sl'   -1   67 0 -5   116 0 -1 };
