...
integer :: n(4), np(3), npg(3), nt, nhalo, npml, bc(6), ipe, &
  nrmdim, nclramp, hypocenter(3), &
  nmat, mati(nz,0), nfric, ntrac, nstress, nout, &
  noper, operi(nz,6), nlock, locknodes(nz,9), checkpoint, &
  umaxi(3), vmaxi(3), wmaxi(3), &
  i1node(3), i2node(3), i1nodepml(3), i2nodepml(3), &
  i1cell(3), i2cell(3), i1cellpml(3), i2cellpml(3), &
  i, i1(3), i2(3), j, j1, j2, k, k1, k2, l, l1, l2
real :: dx, dt, nu, rho0, vp, vs, miu0, lam0, vrup, rcrit, &
  viscosity(2), gam(2), msrcradius, umax, vmax, wmax, &
