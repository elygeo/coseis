...
call field_io('<>', 'dc',  dc)
call field_io('<>', 'co',  co)
call field_io('<>', 'sxx', t1(:,:,:,1))
call field_io('<>', 'syy', t1(:,:,:,2))
call field_io('<>', 'szz', t1(:,:,:,3))
call field_io('<>', 'syz', t2(:,:,:,1))
call field_io('<>', 'szx', t2(:,:,:,2))
call field_io('<>', 'sxy', t2(:,:,:,3))
...
call field_io('>', 'tx',  t1(:,:,:,1))
call field_io('>', 'ty',  t1(:,:,:,2))
call field_io('>', 'tz',  t1(:,:,:,3))
call field_io('>', 'tsx', t3(:,:,:,1))
call field_io('>', 'tsy', t3(:,:,:,2))
call field_io('>', 'tsz', t3(:,:,:,3))
...
f2 = sqrt(sum(t2 * t2, 4))
call field_io('>', 'sax', t2(:,:,:,1))
call field_io('>', 'say', t2(:,:,:,2))
call field_io('>', 'saz', t2(:,:,:,3))
