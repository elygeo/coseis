...
case( 'src_type' );     read( str, *, iostat=io ) key, op, src_type
case( 'src_function' ); read( str, *, iostat=io ) key, op, src_function
case( 'src_period' );   read( str, *, iostat=io ) key, op, src_period
case( 'src_w1' );       read( str, *, iostat=io ) key, op, src_w1
case( 'src_w2' );       read( str, *, iostat=io ) key, op, src_w2
case( 'src_n' );        read( str, *, iostat=io ) key, op, src_n
