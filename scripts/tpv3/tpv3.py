...
for _i in range( 0, len( _run ), 2 ):
    ...
    fieldio = [
       ...
       #( '=c', 'ts',   [], 81.6e6 (-1499., -1499.,    -1.), (1499.,  1499.,    1.) ),
        ...
        ( '=',  'mus',  [_jj,_kk,_l, ()],  0.677     ),
        ( '=',  'ts',   [_oo,_oo,_l, ()],  72.9e6    ),
        ( '=',  'ts',   [_xx,_oo,_l, ()],  75.8e6    ),
        ( '=',  'ts',   [_oo,_xx,_l, ()],  75.8e6    ),
        ( '=',  'ts',   [_xx,_xx,_l, ()],  81.6e6    ),
        ( '=w', 'x1',   [_jj,_kk,_l, ()], 'flt-x1'   ),
        ( '=w', 'x2',   [_jj,_kk,_l, ()], 'flt-x2'   ),
       ...
       #( '=w', 'tnm',  [_jj,_k, _l, ()], 'xt-tnm'   ),
       #( '=w', 'tsm',  [_jj,_k, _l, ()], 'xt-tsm'   ),
       #( '=w', 'sam',  [_jj,_k, _l, ()], 'xt-sam'   ),
       #( '=w', 'svm',  [_jj,_k, _l, ()], 'xt-svm'   ),
       #( '=w', 'sl',   [_jj,_k, _l, ()], 'xt-sl'    ),
