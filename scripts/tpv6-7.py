...
dt = dx[0] / 12500.
nn = (
    int( 33000. / dx[0] + 41.001 ),
    int( 18000. / dx[1] + 41.001 ),
    int( 12000. / dx[2] + 40.001 ),
)
nt = int( 12. / dt + 1.5 )
bc1 = 10,  0, 10
bc2 = 10, 10, 10
...
irup = nn[2]/2
_j   = nn[0]/2
_k     = int(  7500. / dx[1] + 1.001 )
_1500  = int(  1500. / dx[0] + 0.001 )
_4500  = int(  4500. / dx[0] + 0.001 )
_15000 = int( 15000. / dx[0] + 0.001 )
