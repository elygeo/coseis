...
mpa = [];
for iz = 1:size( vplanes, 1 )
  [ i1, i2 ] = zoneselect( vplanes(iz,:), 0, core, hypocenter, nrmdim );
  j = i1(1):i2(1);
  k = i1(2):i2(2);
  l = i1(3):i2(3);
  np = i2 - i1 + 1;
...
for iz = 1:size( visosurfs, 1 )
  [ i1, i2 ] = zoneselect( visosurfs(iz,:), 0, core, hypocenter, nrmdim );
  j = i1(1):i2(1);
  k = i1(2):i2(2);
  l = i1(3):i2(3);
  np = i2 - i1 + 1;
...
for iz = 1:size( vglyphs, 1 )
  [ i1, i2 ] = zoneselect( vglyphs(iz,:), 0, core, hypocenter, nrmdim );
  j = i1(1):i2(1);
  k = i1(2):i2(2);
  l = i1(3):i2(3);
  o = i1 - 1;
...
for iz = 1:size( Sglyphs, 1 )
  [ i1, i2 ] = zoneselect( Sglyphs(iz,:), 0, core, hypocenter, nrmdim );
  i2 = i2 - 1;
  j = i1(1):i2(1);
  k = i1(2):i2(2);
  l = i1(3):i2(3);
