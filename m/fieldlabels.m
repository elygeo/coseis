...
case 'sa',   labels = { 'Slip Acceleration' '|A|' 'A_x' 'A_y' 'A_z' };
case 'sv',   labels = { 'Slip Velocity'     '|V|' 'V_x' 'V_y' 'V_z' };
case 'su',   labels = { 'Slip'              '|U|' 'U_x' 'U_y' 'U_z' };
case 'ts',   labels = { 'Shear Traction'    '|T|' 'T_x' 'T_y' 'T_z' };
case 't',    labels = { 'Traction'          '|T|' 'T_x' 'T_y' 'T_z' };
case 'sam',  labels = { 'Slip Acceleration' '|A|' };
case 'svm',  labels = { 'Slip Velocity'     '|V|' };
case 'sum',  labels = { 'Slip'              '|U|' };
...
case 'svp',  labels = { 'Peak Slip Velocity' '|V|_{peak}' };
