...
if crop
  !gsed '/% macros for lines/i/DA { [1 dpi2point mul] 0 setdash } bdef /DD { [.5 dpi2point mul 1 dpi2point mul 6 dpi2point mul 1 dpi2point mul] 0 setdash } bdef' tmp.eps | ps2pdf14 -dPDFSETTINGS=/prepress -dEPSCrop - tmp.pdf
else
