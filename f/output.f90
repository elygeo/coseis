...
do ic = 1, nc
  ...
  case( 'x'    ); call vectorio( 'w', str, rr, w1,   i1, i2, i3, i4, ic,   ir, iz, i )
  case( 'rho'  ); call scalario( 'w', str, rr, mr,   i1, i2, i3, i4,       ir, iz, i )
  case( 'vp'   ); call scalario( 'w', str, rr, s1,   i1, i2, i3, i4,       ir, iz, i )
  case( 'vs'   ); call scalario( 'w', str, rr, s2,   i1, i2, i3, i4,       ir, iz, i )
  case( 'mu'   ); call scalario( 'w', str, rr, mu,   i1, i2, i3, i4,       ir, iz, i )
  case( 'lam'  ); call scalario( 'w', str, rr, lam,  i1, i2, i3, i4,       ir, iz, i )
  case( 'v'    ); call vectorio( 'w', str, rr, v,    i1, i2, i3, i4, ic,   ir, iz, i )
  case( 'u'    ); call vectorio( 'w', str, rr, u,    i1, i2, i3, i4, ic,   ir, iz, i )
  case( 'w'    );                                                                  
   if ( ic < 4 )  call vectorio( 'w', str, rr, w1,   i1, i2, i3, i4, ic,   ir, iz, i )
   if ( ic > 3 )  call vectorio( 'w', str, rr, w2,   i1, i2, i3, i4, ic-3, ir, iz, i )
  case( 'a'    ); call vectorio( 'w', str, rr, w1,   i1, i2, i3, i4, ic,   ir, iz, i )
  case( 'vm2'  ); call scalario( 'w', str, rr, s1,   i1, i2, i3, i4,       ir, iz, i )
  case( 'um2'  ); call scalario( 'w', str, rr, s1,   i1, i2, i3, i4,       ir, iz, i )
  case( 'wm2'  ); call scalario( 'w', str, rr, s2,   i1, i2, i3, i4,       ir, iz, i )
  case( 'am2'  ); call scalario( 'w', str, rr, s2,   i1, i2, i3, i4,       ir, iz, i )
  case( 'pv2'  ); call scalario( 'w', str, rr, pv,   i1, i2, i3, i4,       ir, iz, i )
  case( 'nhat' ); call vectorio( 'w', str, rr, nhat, i1, i2, i3, i4, ic,   ir, iz, i )
  case( 'mus'  ); call scalario( 'w', str, rr, mus,  i1, i2, i3, i4,       ir, iz, i )
  case( 'mud'  ); call scalario( 'w', str, rr, mud,  i1, i2, i3, i4,       ir, iz, i )
  case( 'dc'   ); call scalario( 'w', str, rr, dc,   i1, i2, i3, i4,       ir, iz, i )
  case( 'co'   ); call scalario( 'w', str, rr, co,   i1, i2, i3, i4,       ir, iz, i )
  case( 'sv'   ); call vectorio( 'w', str, rr, t1,   i1, i2, i3, i4, ic,   ir, iz, i )
  case( 'su'   ); call vectorio( 'w', str, rr, t2,   i1, i2, i3, i4, ic,   ir, iz, i )
  case( 'ts'   ); call vectorio( 'w', str, rr, t1,   i1, i2, i3, i4, ic,   ir, iz, i )
  case( 'sa'   ); call vectorio( 'w', str, rr, t2,   i1, i2, i3, i4, ic,   ir, iz, i )
  case( 'svm'  ); call scalario( 'w', str, rr, f1,   i1, i2, i3, i4,       ir, iz, i )
  case( 'sum'  ); call scalario( 'w', str, rr, f2,   i1, i2, i3, i4,       ir, iz, i )
  case( 'tsm'  ); call scalario( 'w', str, rr, ts,   i1, i2, i3, i4,       ir, iz, i )
  case( 'sam'  ); call scalario( 'w', str, rr, f2,   i1, i2, i3, i4,       ir, iz, i )
  case( 'tn'   ); call scalario( 'w', str, rr, tn,   i1, i2, i3, i4,       ir, iz, i )
  case( 'fr'   ); call scalario( 'w', str, rr, f1,   i1, i2, i3, i4,       ir, iz, i )
  case( 'sl'   ); call scalario( 'w', str, rr, sl,   i1, i2, i3, i4,       ir, iz, i )
  case( 'psv'  ); call scalario( 'w', str, rr, psv,  i1, i2, i3, i4,       ir, iz, i )
  case( 'trup' ); call scalario( 'w', str, rr, trup, i1, i2, i3, i4,       ir, iz, i )
  case( 'tarr' ); call scalario( 'w', str, rr, tarr, i1, i2, i3, i4,       ir, iz, i )
  case default
