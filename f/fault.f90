...
case( 'r' )
  ...
  case( 'mus' ); call scalario( 'r', 'data/mus', rr, mus,   i1, i2, i3, i4, ifn, endian )
  case( 'mud' ); call scalario( 'r', 'data/mud', rr, mud,   i1, i2, i3, i4, ifn, endian )
  case( 'dc'  ); call scalario( 'r', 'data/dc',  rr, dc,    i1, i2, i3, i4, ifn, endian )
  case( 'co'  ); call scalario( 'r', 'data/co',  rr, co,    i1, i2, i3, i4, ifn, endian )
  case( 'sxx' ); call vectorio( 'r', 'data/sxx', rr, t1, 1, i1, i2, i3, i4, ifn, endian )
  case( 'syy' ); call vectorio( 'r', 'data/syy', rr, t1, 2, i1, i2, i3, i4, ifn, endian )
  case( 'szz' ); call vectorio( 'r', 'data/szz', rr, t1, 3, i1, i2, i3, i4, ifn, endian )
  case( 'syz' ); call vectorio( 'r', 'data/syz', rr, t2, 1, i1, i2, i3, i4, ifn, endian )
  case( 'szx' ); call vectorio( 'r', 'data/szx', rr, t2, 2, i1, i2, i3, i4, ifn, endian )
  case( 'sxy' ); call vectorio( 'r', 'data/szy', rr, t2, 3, i1, i2, i3, i4, ifn, endian )
  case( 'ts1' ); call vectorio( 'r', 'data/ts1', rr, t3, 1, i1, i2, i3, i4, ifn, endian )
  case( 'ts2' ); call vectorio( 'r', 'data/ts2', rr, t3, 2, i1, i2, i3, i4, ifn, endian )
  case( 'tn'  ); call vectorio( 'r', 'data/tn',  rr, t3, 3, i1, i2, i3, i4, ifn, endian )
  end select
case( 'z' )
  rr = inval(iz)
  i1 = i1in(iz,:)
