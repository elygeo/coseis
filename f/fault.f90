...
case( 'r' )
  ...
  case( 'sxx' ); call vectorio( 'r', 'data/sxx', rr, t1, 1, i1, i2, i3, i4, 1, ifn )
  case( 'syy' ); call vectorio( 'r', 'data/syy', rr, t1, 2, i1, i2, i3, i4, 1, ifn )
  case( 'szz' ); call vectorio( 'r', 'data/szz', rr, t1, 3, i1, i2, i3, i4, 1, ifn )
  case( 'syz' ); call vectorio( 'r', 'data/syz', rr, t2, 1, i1, i2, i3, i4, 1, ifn )
  case( 'szx' ); call vectorio( 'r', 'data/szx', rr, t2, 2, i1, i2, i3, i4, 1, ifn )
  case( 'sxy' ); call vectorio( 'r', 'data/szy', rr, t2, 3, i1, i2, i3, i4, 1, ifn )
  case( 'ts1' ); call vectorio( 'r', 'data/ts1', rr, t3, 1, i1, i2, i3, i4, 1, ifn )
  case( 'ts2' ); call vectorio( 'r', 'data/ts2', rr, t3, 2, i1, i2, i3, i4, 1, ifn )
  case( 'tn'  ); call vectorio( 'r', 'data/tn',  rr, t3, 3, i1, i2, i3, i4, 1, ifn )
  end select
case( 'z' )
  rr = inval(iz)
  i1 = i1in(iz,:)
