...
case( 'r' )
  ...
  case( 'mus' ); call scalario( 'r', 'data/mus', rr, mus, i1, i2, i3, i4,    1, i )
  case( 'mud' ); call scalario( 'r', 'data/mud', rr, mud, i1, i2, i3, i4,    1, i )
  case( 'dc'  ); call scalario( 'r', 'data/dc',  rr, dc,  i1, i2, i3, i4,    1, i )
  case( 'co'  ); call scalario( 'r', 'data/co',  rr, co,  i1, i2, i3, i4,    1, i )
  case( 'sxx' ); call vectorio( 'r', 'data/sxx', rr, t1,  i1, i2, i3, i4, 1, 1, i )
  case( 'syy' ); call vectorio( 'r', 'data/syy', rr, t1,  i1, i2, i3, i4, 2, 1, i )
  case( 'szz' ); call vectorio( 'r', 'data/szz', rr, t1,  i1, i2, i3, i4, 3, 1, i )
  case( 'syz' ); call vectorio( 'r', 'data/syz', rr, t2,  i1, i2, i3, i4, 1, 1, i )
  case( 'szx' ); call vectorio( 'r', 'data/szx', rr, t2,  i1, i2, i3, i4, 2, 1, i )
  case( 'sxy' ); call vectorio( 'r', 'data/szy', rr, t2,  i1, i2, i3, i4, 3, 1, i )
  case( 'ts1' ); call vectorio( 'r', 'data/ts1', rr, t3,  i1, i2, i3, i4, 1, 1, i )
  case( 'ts2' ); call vectorio( 'r', 'data/ts2', rr, t3,  i1, i2, i3, i4, 2, 1, i )
  case( 'tn'  ); call vectorio( 'r', 'data/tn',  rr, t3,  i1, i2, i3, i4, 3, 1, i )
  end select
case( 'z' )
  rr = inval(iz)
  i1 = i1in(iz,:)
