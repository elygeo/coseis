...
case( 'r' )
  ...
  case( 'mus' ); call scalario( -1, i, rr, 'data/mus', mus,   i1, i2, i3, i4, 1, 1 )
  case( 'mud' ); call scalario( -1, i, rr, 'data/mud', mud,   i1, i2, i3, i4, 1, 1 )
  case( 'dc'  ); call scalario( -1, i, rr, 'data/dc',  dc,    i1, i2, i3, i4, 1, 1 )
  case( 'co'  ); call scalario( -1, i, rr, 'data/co',  co,    i1, i2, i3, i4, 1, 1 )
  case( 'sxx' ); call vectorio( -1, i, rr, 'data/sxx', t1, 1, i1, i2, i3, i4, 1, 1 )
  case( 'syy' ); call vectorio( -1, i, rr, 'data/syy', t1, 2, i1, i2, i3, i4, 1, 1 )
  case( 'szz' ); call vectorio( -1, i, rr, 'data/szz', t1, 3, i1, i2, i3, i4, 1, 1 )
  case( 'syz' ); call vectorio( -1, i, rr, 'data/syz', t2, 1, i1, i2, i3, i4, 1, 1 )
  case( 'szx' ); call vectorio( -1, i, rr, 'data/szx', t2, 2, i1, i2, i3, i4, 1, 1 )
  case( 'sxy' ); call vectorio( -1, i, rr, 'data/sxy', t2, 3, i1, i2, i3, i4, 1, 1 )
  case( 'ts1' ); call vectorio( -1, i, rr, 'data/ts1', t3, 1, i1, i2, i3, i4, 1, 1 )
  case( 'ts2' ); call vectorio( -1, i, rr, 'data/ts2', t3, 2, i1, i2, i3, i4, 1, 1 )
  case( 'tn'  ); call vectorio( -1, i, rr, 'data/tn',  t3, 3, i1, i2, i3, i4, 1, 1 )
  end select
case( 'z' )
  rr = inval(iz)
  select case ( fieldin(iz) )
...
call scalarbc( mus,   bc1, bc2, i1bc, i2bc, 0 )
call scalarbc( mud,   bc1, bc2, i1bc, i2bc, 0 )
call scalarbc( dc,    bc1, bc2, i1bc, i2bc, 0 )
call scalarbc( co,    bc1, bc2, i1bc, i2bc, 0 )
call scalarbc( area,  bc1, bc2, i1bc, i2bc, 0 )
call scalarbc( rhypo, bc1, bc2, i1bc, i2bc, 0 )
call vectorbc( nhat,  bc1, bc2, i1bc, i2bc, 0 )
call vectorbc( t0,    bc1, bc2, i1bc, i2bc, 0 )
